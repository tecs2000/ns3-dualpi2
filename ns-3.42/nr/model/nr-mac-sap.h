...
class NrMacSapUser
{
  public:
    ...
    /**
     * Called by the MAC to notify the RLC of the reception of a new CQI data
     *
     * \param params the CQI value received
     */
    virtual void SetCqi(uint16_t rnti, uint8_t lcid, uint8_t cqi) = 0;
};
