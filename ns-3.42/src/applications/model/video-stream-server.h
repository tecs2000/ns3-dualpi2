...
class VideoStreamServer : public Application
{
  ...
  private:
    ...
    typedef struct ClientInfo
    {
        ...
        bool l4s = false;              //!< If protocol is scalable
    ...
    std::map<uint32_t, ClientInfo*> m_clients;       // Map of client information
    ...
    const uint32_t m_frameSizes[6] = {0,
                                      230400,
                                      345600,
                                      921600,
                                      2073600,
                                      2211840}; //!< Frame size for 360p, 480p, 720p, 1080p and 2K
};
